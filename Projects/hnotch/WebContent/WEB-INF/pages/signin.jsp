...
<html lang="en">
   <head>
      <meta charset="utf-8">
      <title>Sign in &middot; hnotch</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form:form class="form-signin" action = "signin" commandName="User">
		...
		Email
        <form:input type="text" class="input-block-level" placeholder="Email address" path = "Emailaddress" autofocus = "autofocus"/>
		Password
		...
		<a class="btn btn-info pull-right" href = "signup">
           Register
           <i class="icon-circle-arrow-right"></i>
        </a>
      </form:form><br><br>
		<a class="btn btn-link btn-block" onclick="javascript: windowPopup('forgotpassword', 'Forgot Password'); return false;">
           Forgot Password
           <i class="icon-circle-arrow-right"></i>
        </a>
