...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid" style="margin-top: 25px">
			<div class="span3">
				<div class="sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="appcenter">My Apps</a></li>
						<li><a href="allapps">All Apps</a></li>
					</ul>
				</div>
				<!--/.well -->
			</div>
			...
			<div class="span9">
				<c:choose>
					<c:when test="${not empty param.msg && param.msg == 1}">
						<div class="alert alert-success text-center">Application
							deleted sucessfully !</div>
					</c:when>
					<c:when test="${not empty param.msg && param.msg == 3}">
						<div class="alert alert-success text-center">Application
							installed sucessfully !</div>
					</c:when>
					<c:when test="${not empty param.msg && param.msg == 6}">
						<div class="alert alert-success text-center">Comment deleted
							sucessfully !</div>
					</c:when>
				</c:choose>
				<c:choose>
					<c:when test="${fn:length(UserApplications) > 0}">
						<c:forEach var="applications" items="${UserApplications }">
							<div class="row-fluid">
								<div class="span12">
									<div class="card">
										<div class="card-heading image">
											...
											<div class="card-heading-header">
												...
												<a class="btn btn-small btn-block btn-danger"
													href="app/delete/${applications.applicationId}">Delete</a>
											</div>
										</div>
										<div class="card-body">
						...
						<ul class="pager">
							<li class="previous"><a href="appcenter?page=previous">&larr;
									Previous</a></li>
							<li class="next"><a href="appcenter?page=next">Next
									&rarr;</a></li>
						</ul>
			</div>
			<!--/span-->
		...
		<c:otherwise>
			<div class="card">
				<div class="card-body">
					<p style="padding: 0px 0px 10px 0px">No application uploaded.</p>
				</div>
			</div>
		</c:otherwise>
		</c:choose>
