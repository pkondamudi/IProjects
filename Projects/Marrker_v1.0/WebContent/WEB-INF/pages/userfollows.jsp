...
<head>
<meta charset="utf-8">
<title>What am i following? - {Marrker}</title>
	...
	<div class="container">
		...
		<c:choose>
			<c:when test="${fn:length(userBoards) > 0}">
						...
						<div class="card">
							...
							<div class="card-actions">
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li><a href="ctx/unFollow/${userBoard.boardId}">Unfollow</a></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<ul class="pager">
					<li><a href="userFollowing?nav=pre">Previous</a></li>
					<li><a href="userFollowing?nav=nxt">Next</a></li>
				</ul>
			</c:when>
			<c:otherwise>
				<div class="card">
					<div class="card-body">
						<p style="padding: 0px 0px 10px 0px">No contexts found. Start
							searching and following the contexts.</p>
					</div>
				</div>
			</c:otherwise>
		</c:choose>
