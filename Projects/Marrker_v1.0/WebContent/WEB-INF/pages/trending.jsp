...
<body>
	...
	<div class="container">
		...
		<c:choose>
			<c:when test="${fn:length(trendingUserBoards) > 0}">
				<c:forEach var="userBoard" items="${trendingUserBoards}">
					<div class="row">
						<div class="card">
				...
				<ul class="pager">
					<li><a href="trending?nav=pre">Previous</a></li>
					<li><a href="trending?nav=nxt">Next</a></li>
				</ul>
			</c:when>
			<c:otherwise>
				<div class="card">
					<div class="card-body">
						<p style="padding: 0px 0px 10px 0px">Your are following all
							that is trending.</p>
					</div>
				</div>
			</c:otherwise>
